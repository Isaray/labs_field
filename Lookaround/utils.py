...
def make_optimizer(cfg, net):
    ...
    if cfg.SOLVER.OPTIMIZER_NAME == "LookaroundSelect":
        return LookaroundSelect(net.parameters(), lr=cfg.SOLVER.LR, momentum=0.9, weight_decay=5e-4, head_num=cfg.BUILD_TRANSFORM_NUM, frequence=cfg.SOLVER.FREQUENCY)
