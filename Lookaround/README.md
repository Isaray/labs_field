...
python mytrain.py --yaml_path='resnet50_cifar100.yaml' --train_mode='TRAIN_LOOKAROUNDSELECT' --cuda_id=0 --data_dir='dataset/' --out='./out/' --optimizer='LookaroundSelect' --tag='five-select-1-seed1'  --tnum=3 --seed 1
python mytrain.py --yaml_path='resnet50_cifar100.yaml' --train_mode='TRAIN_LOOKAROUNDSELECT' --cuda_id=0 --data_dir='dataset/' --out='./out/' --optimizer='LookaroundSelect' --tag='five-select-1-seed1'  --tnum=3 --seed 2
